...
# Assert
TARGET_OTA_ASSERT_DEVICE := E2M

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 21284040 # This is the maximum known partition size, but it can be higher, so we just omit it
